<div class="btn-actions-pane-right">
    ...
    <button type="button" class="btn btn-primary submitFormItem @if($objectId > 0)display-none-block @endif" onclick="jqueryCommon.doSubmitForm();"><i class="pe-7s-diskette"></i> {{viewLanguage('Update')}}</button>
