...
<!--                                                                                    <img src="{{Config::get('config.WEB_ROOT')}}assets/backend/theme/assets/images/avatars/1.jpg" alt="">-->
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                    <div class="menu-header-image opacity-05" style="background-image: url('{{Config::get('config.WEB_ROOT')}}assets/backend/theme/assets/images/dropdown-header/city2.jpg');"></div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-premium-dark">
                                    <div class="menu-header-image" style="background-image: url('{{Config::get('config.WEB_ROOT')}}assets/backend/theme/assets/images/dropdown-header/abstract4.jpg');"></div>
            ...
            <div class="app-footer-right">
                <ul class="header-megamenu nav">
                    <li class="nav-item">
                        <div class="nav-link">{!! \App\Library\AdminFunction\CGlobal::copy_right !!}</div>
                    </li>
                            ...
                            <div class="d-none popover-custom-content">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-tempting-azure">
                                        <div class="menu-header-image opacity-1" style="background-image: url('{{Config::get('config.WEB_ROOT')}}assets/backend/theme/assets/images/dropdown-header/city5.jpg');"></div>
                                        <div class="menu-header-content text-dark">
