                ...
                <div class="card-body paddingTop-unset">
                    <div class="form-group marginT10 col-lg-12">
                        @if($is_root || $permission_view)
                            <a href="javascript:void(0);" class="mb-2 mr-2 btn-transition btn btn-outline-success detailOtherCommon" onclick="jqueryCommon.getDataByAjax(this);" data-loading="2" data-form-name="addFormOther" data-url="{{$urlAjaxGetData}}" data-function-action="_ajaxActionOther" data-input="{{json_encode(['type'=>'getChangeStatus','functionAction'=>'','dataClaim'=>$data,'dataItem'=>$dataItem,'listDuocBoiThuong'=>$listDuocBoiThuong])}}" data-show="1" data-show-id="" title="{{viewLanguage('Chuyển trạng thái: ')}}{{$data->CONTRACT_NO}}" data-method="post" data-objectId="">
                                <i class="fa fa-refresh"></i> {{viewLanguage('Chuyển trạng thái')}}
                            </a>
                            <a href="javascript:void(0);"  class="mb-2 mr-2 btn-transition btn btn-outline-info detailOtherCommon" onclick="jqueryCommon.getDataByAjax(this);" data-loading="2" data-form-name="addFormOther" data-url="{{$urlAjaxGetData}}" data-function-action="_ajaxActionOther" data-input="{{json_encode(['type'=>'getHistory','functionAction'=>'','dataClaim'=>$listTimeLine])}}" data-show="1" data-show-id="" title="{{viewLanguage('Lịch sử bồi thường: ')}}{{$data->CONTRACT_NO}}" data-method="post" data-objectId="">
                    ...
                    <div class="vertical-without-time vertical-timeline vertical-timeline--animate vertical-timeline--one-column" style="padding-top: 0px!important;">
                        ...
                        <div class="vertical-timeline-item vertical-timeline-element marginBottom-unset">
                            ...
                            <div class="vertical-timeline-element-content bounce-in" id="formShowEditSuccess">
                                @include('Sellings.ClaimIndemnify.ClaimHdi.component._detailFormItem')
                            </div>
                        </div>
                                ...
                                <div class="vertical-timeline-element-content bounce-in">
                                    ...
                                    <div class="tab-content marginT20" >
                                        ...
                                        <div class="tab-pane tabs-animation fade show active" id="{{$tabOtherItem1}}" role="tabpanel">
                                            @include('Sellings.ClaimIndemnify.ClaimHdi.component._detailFormItem2')
                                        </div>
                                        {{--Các giao dịch với khách hàng---}}
                                        <div class="tab-pane tabs-animation fade" id="{{$tabOtherItem2}}" role="tabpanel">
                                            @include('Sellings.ClaimIndemnify.ClaimHdi.component._detailFormItem3')
                                        </div>
                                    </div>
                                </div>
                            </div>
