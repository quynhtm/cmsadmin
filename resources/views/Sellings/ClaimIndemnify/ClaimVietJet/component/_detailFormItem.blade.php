<div>
    ...
    <div class="formInforItem  @if($objectId <= 0)display-none-block @endif" >
        <div class="">
            ...
            <div class="form-group marginT20 display-none-block">
                <h4>Người khai báo</h4>
                <div class="row form-group">
                    <div class="col-lg-4">
                        Họ tên: <b class="showInforItem" data-field="">01/04/2021</b>
                    </div>
                    <div class="col-lg-4">
                        Quan hệ với NĐBH: <b class="showInforItem" data-field="">App</b>
                    </div>
                    <div class="col-lg-4">
                        CMND/CCCD/Hộ chiếu: <b class="showInforItem" data-field="">Nguyễn Văn A</b>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-4">
                        Ngày sinh: <b class="showInforItem" data-field="">01/04/2021</b>
                    </div>
                    <div class="col-lg-4">
                        Số điện thoại: <b class="showInforItem" data-field="">App</b>
                    </div>
                    <div class="col-lg-4">
                        Email: <b class="showInforItem" data-field="">Nguyễn Văn A</b>
                    </div>
                </div>
            </div>
        </div>
