                    ...
                    <tr>
                        ...
                        <td class="text-center middle">
                            @if($is_root || $permission_view || $permission_add)
                                <a href="javascript:void(0);" style="color: green" onclick="jqueryCommon.getDataByAjax(this);" data-form-name="addFormOther" data-url="{{$urlAjaxGetData}}" data-function-action="_ajaxActionOther" data-input="{{json_encode(['type'=>'getTimeLine','functionAction'=>'','dataClaim'=>[],'arrKey'=>['ORG_CODE'=>$item->ORG_CODE,'PRODUCT_CODE'=>$item->PRODUCT_CODE,'CLAIM_CODE'=>$item->CLAIM_CODE]])}}" data-show="1" data-show-id="" title="{{viewLanguage('Lịch sử thao tác: ')}}{{$item->CONTRACT_NO}}" data-method="post" data-objectId="">
                                    <i class="pe-7s-graph3 fa-2x"></i>
                                </a>
                            @endif
                        </td>
