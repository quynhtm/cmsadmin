...
<head>
    ...
    <meta name="description" content="SDK-HDI"/>
    <link rel="apple-touch-icon" href="/logo192.png"/>
    <link rel="manifest" href="/manifest.json"/>
    <title>SDK- HD Insurance</title>

    <link media="all" type="text/css" rel="stylesheet" href="{{URL::asset('assets/sdk/css/app.css')}}"/>
    <link media="all" type="text/css" rel="stylesheet" href="{{URL::asset('assets/sdk/static/css/main.d8127343.chunk.css')}}"/>
    <link media="all" type="text/css" rel="stylesheet" href="{{URL::asset('assets/sdk/static/css/main.d8127343.chunk.css')}}"/>
</head>
<body>
...
<script>!function (e) {
        ...
        i.e = function (e) {
            ...
            if (0 !== t) if (t) r.push(t[2]); else {
                ...
                a.charset = "utf-8", a.timeout = 120, i.nc && a.setAttribute("nonce", i.nc), a.src = function (e) {
                    return i.p + "static/js/" + ({}[e] || e) + "." + {3: "a6f7cc96"}[e] + ".chunk.js"
                }(e);
                var c = new Error;
                u = function (r) {
        ...
        var a = this["webpackJsonpselling-b2b"] = this["webpackJsonpselling-b2b"] || [], c = a.push.bind(a);
        a.push = r, a = a.slice();
...
<script src="{{URL::asset('assets/sdk/static/js/2.ec715f1b.chunk.js')}}"></script>
<script src="{{URL::asset('assets/sdk/static/js/main.e1586dab.chunk.js')}}"></script>
