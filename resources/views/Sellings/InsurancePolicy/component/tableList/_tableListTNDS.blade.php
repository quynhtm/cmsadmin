        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tr class="table-background-header">
                    ...
                    <th width="6%" class="text-center middle">{{viewLanguage('Ngày tạo')}}</th>
                    <th width="18%" class="text-center middle">{{viewLanguage('Sản phẩm')}}</th>
                ...
                @foreach ($data as $key => $item)
                    <tr>
                        ...
                        <td class="text-left middle">@if(isset($item->ORG_SELLER_NAME)){{$item->ORG_SELLER_NAME}}@endif</td>
                        <td class="text-center middle">@if(isset($item->SELLER_NAME)){{$item->SELLER_NAME}}@endif</td>
