...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="{{URL::asset('assets/backend/theme/main.css')}}"/>
    <script type="text/javascript" src="{{URL::asset('assets/backend/theme/assets/scripts/main.js')}}"></script>
</head>
