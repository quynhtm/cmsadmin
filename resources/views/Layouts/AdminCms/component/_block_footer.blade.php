                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
<!--                                                <img width="42" class="rounded" src="{{Config::get('config.WEB_ROOT')}}assets/backend/architectuiTheme/assets/images/avatars/1.jpg" alt="" />-->
                                            </div>
                                        </div>
                                        <div class="widget-content-left">
...
<!--                                                        <img src="{{Config::get('config.WEB_ROOT')}}assets/backend/architectuiTheme/assets/images/avatars/1.jpg" alt="">-->
                                                    </div>
                                                </div>
