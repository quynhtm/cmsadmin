                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            <label for="depart_alias">{{viewLanguage('Loại tổ chức')}}</label>
                            <select class="form-control input-sm" name="ORG_TYPE" id="ORG_TYPE" >
                                {!! $optionType !!}
                            </select>
                        </div>
                        {{--<div class="form-group col-lg-6">
                            <label for="depart_alias">{{viewLanguage('Kiểu đối tác')}}</label>
                            <select class="form-control input-sm" name="ORG_MODE" id="ORG_MODE" >
                                {!! $optionType !!}
                            </select>
                        </div>--}}
                        <div class="form-group col-lg-6">
