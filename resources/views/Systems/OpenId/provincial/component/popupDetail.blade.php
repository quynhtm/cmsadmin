                        ...
                        <form id="form_{{$formName}}">
                            <div class="vertical-timeline-item vertical-timeline-element marginBottom-unset">
                                ...
                                <div class="vertical-timeline-element-content bounce-in" id="formShowEditSuccess">
                                    @include('Systems.OpenId.provincial.component._detailFormItem')
                                </div>
                            </div>
                        </form>
                                        ...
                                        <div class="listTabWithAjax">
                                            <div class="card-header card-header-tab-animation">
                                                <ul class="nav nav-justified">
                                                    <li class="nav-item">
                                                        <a role="tab" class="nav-link active" data-toggle="tab" href="#tab-content-1" onclick="jqueryCommon.ajaxGetData(this);" data-show-id="tab-content-1" data-url="{{$urlAjaxGetData}}" data-function-action="_ajaxGetItem" data-input="{{json_encode(['type'=>$tabOtherItem1,'item_id'=>0])}}" data-object-id="{{$data->USER_CODE}}">
                                                            <span>{{viewLanguage('Thông tin cá nhân')}}</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a role="tab" class="nav-link" data-toggle="tab" href="#tab-content-2" onclick="jqueryCommon.ajaxGetData(this);" data-show-id="tab-content-2" data-url="{{$urlAjaxGetData}}" data-function-action="_ajaxGetItem" data-input="{{json_encode(['type'=>$tabOtherItem2,'item_id'=>0])}}" data-object-id="{{$data->USER_CODE}}">
                                                            <span>{{viewLanguage('Phân quyền theo nhóm')}}</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a role="tab" class="nav-link" data-toggle="tab" href="#tab-content-3" onclick="jqueryCommon.ajaxGetData(this);" data-show-id="tab-content-3" data-url="{{$urlAjaxGetData}}" data-function-action="_ajaxGetItem" data-input="{{json_encode(['type'=>$tabOtherItem3,'item_id'=>0])}}" data-object-id="{{$data->USER_CODE}}">
                                            ...
                                            <div class="tab-content marginT10" >
                                                ...
                                                <div class="tab-pane tabs-animation fade show active" id="tab-content-1" role="tabpanel">
                                                    @include('Systems.OpenId.provincial.component._formUserAbout')
                                                </div>
