<div style="position: relative">
    ...
    <div id="divDetailItem">
        <div class="card-header">
            @if($objectId > 0)Cập nhật thông tin version @else Thêm thông tin version @endif
                        ...
                        <form id="form_{{$formName}}">
                            <div class="vertical-timeline-item vertical-timeline-element marginBottom-unset">
                                ...
                                <div class="vertical-timeline-element-content bounce-in" id="formShowEditSuccess">
                                    @include('Systems.OpenApi.versionsApi.component._detailFormItem')
                                </div>
                            </div>
                        </form>
                            ...
                            <div>
                                ...
                                <div class="vertical-timeline-element-content bounce-in">
                                    ...
                                    @if($objectId <= 0)
                                        ...
                                        <div class="marginT15">
                                            Bạn cần thêm version trước khi nhập chi tiết
                                        </div>
                                    @else
                                        <div class="card-header">{{viewLanguage('Chi tiết version')}}</div>
                                        <div class="listTabWithAjax">
                                            <div class="tab-content marginT10" >
                                                ...
                                                <div class="tab-pane tabs-animation fade show active" id="{{$tabOtherItem1}}" role="tabpanel">
                                                    @include('Systems.OpenApi.versionsApi.component._listDetailVersion')
                                                </div>
                                            </div>
                                        </div>
                                    @endif
