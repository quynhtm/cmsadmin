                    ...
                    <div class="footer__center__item16">
                        <div class="uk-grid-small uk-grid-30-m" uk-grid>
                            ...
                            <div class="uk-width-1-3@m chitiettintuc__boxComment__column">
                                ...
                                <form method="post" action="{{URL::route('site.indexCartOrder2')}}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <div class="footer__center__item24">
                                        <div class="uk-grid-small" uk-grid>
                                            <div class="uk-width-expand">
                                                <input class="uk-input modal__wishList__form__input" type="text" placeholder="Mã giảm giá" name="discount_code" id="discount_code">
                                            </div>
                                    ...
                                    <div class="footer__center__item24">
                                        ...
                                        <div class="giohang__card__item giohang__card__item--divider">
                                            <div class="uk-grid uk-grid-small uk-flex-middle" uk-grid="">
                                                ...
                                                <div class="uk-width-auto">
                                                    <span class="quantam__table__price quantam__table__price--c1 quantam__table__price--c2">{{numberFormat($totalMoneyCart+$shipping_fee)}}đ</span>
                                                </div>
                                            </div>
                                        </div>
