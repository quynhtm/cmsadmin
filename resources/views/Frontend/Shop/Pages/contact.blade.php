                ...
                <div class="uk-grid-24 uk-grid-30-m uk-child-width-1-2@m uk-grid-match" uk-grid>
                    ...
                    <div>
                        ...
                        <form class="uk-grid-16 uk-grid-30-m" uk-grid id="{{$form_id_contact}}" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="contact_title" name="contact_title" value="Liên hệ từ trang Liên hệ">
                            ...
                            <div class="uk-width-1-1 home__tuvan__column">
                                <textarea class="uk-textarea modal__wishList__form__input" rows="5" name="contact_content" placeholder="Lời nhắn *"></textarea>
                            </div>
