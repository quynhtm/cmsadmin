                    ...
                    @if($product->product_sale == STATUS_INT_MOT)
                        <div class="uk-transition-fade uk-position-cover home__product__card__stock uk-flex uk-flex-middle uk-flex-center">
                            <div>
                                ...
                                <a href="javascript:void(0)" onclick="ActionSite.addOneProductToCart('{{setStrVar($product->id)}}',1);" class="home__product__card__stock__icon home__product__card__stock__icon--cart uk-border-circle"></a>
