...
//Action Permiss
define('PERMISS_FULL','PERMISS_FULL');
define('PERMISS_VIEW','PERMISS_VIEW');
define('PERMISS_ADD','PERMISS_ADD');
define('PERMISS_EDIT','PERMISS_EDIT');
define('PERMISS_REMOVE','PERMISS_REMOVE');
define('PERMISS_APPROVE','PERMISS_APPROVE');
