...
define('DEFINE_DIA_DIEM_TUYEN_DUNG','DIA_DIEM_TUYEN_DUNG');
define('DEFINE_PERMISSION_ACTION','PERMISSION_ACTION');
define('DEFINE_ORDER_COD','ORDER_COD');
define('DEFINE_ORDER_STATUS','ORDER_STATUS');
define('DEFINE_ORDER_TYPE','ORDER_TYPE');
define('DEFINE_PRODUCT_PRICE','PRODUCT_PRICE');
define('DEFINE_PRODUCT_TYPE','PRODUCT_TYPE');
define('DEFINE_PRODUCT_SALE','PRODUCT_SALE');
define('DEFINE_PAYMENT_METHODS','PAYMENT_METHODS');
