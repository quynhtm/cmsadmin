...
class PartnerRegistrationController extends BaseAdminController
{
    private $error = array();
    ...
    private $routerIndex = 'partnerRegistration.index';
    private $templateRoot = DIR_PRO_SHOP . '/' . 'PartnerRegistration.';
    ...
    private function _outDataView($request, $data)
    {
        ...
        return $this->dataOutCommon = [
            ...
            'urlGetData' => URL::route('partnerRegistration.ajaxGetData'),
            'urlPostData' => URL::route('partnerRegistration.ajaxPostData'),
        ];
    }
