...
class RecruitmentApplyController extends BaseAdminController
{
    private $error = array();
    ...
    private $routerIndex = 'recruitmentApply.index';
    private $templateRoot = DIR_PRO_WEB . '/' . 'RecruitmentApply.';
    ...
    private function _outDataView($request, $data)
    {
        ...
        $this->pageTitle = CGlobal::$pageAdminTitle = 'Quản lý ứng tuyển';
        ...
        return $this->dataOutCommon = [
            ...
            'urlGetData' => URL::route('recruitmentApply.ajaxGetData'),
            'urlPostData' => URL::route('recruitmentApply.ajaxPostData'),
        ];
    }
