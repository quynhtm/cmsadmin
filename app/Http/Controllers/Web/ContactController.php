...
class ContactController extends BaseAdminController
{
    ...
    private $routerIndex = 'contact.index';
    private $templateRoot = DIR_PRO_WEB . '/' . 'Contact.';
    ...
    private function _outDataView($request, $data)
    {
        ...
        return $this->dataOutCommon = [
            ...
            'urlGetData' => URL::route('contact.ajaxGetData'),
            'urlPostData' => URL::route('contact.ajaxPostData'),
        ];
    }
