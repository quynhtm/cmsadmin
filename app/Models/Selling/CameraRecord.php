...
class CameraRecord extends ModelService
{
    /*********************************************************************************************************
     * Thanh toán hợp đồng
     *********************************************************************************************************/
    ...
    private function buildParam($dataRequest = [])
    {
        $arrParam = [
            ...
            'A10' => (isset($dataRequest['p_place_from'])) ? $dataRequest['p_place_from'] : '',//PLACE_FROM, PLACE_OF_ASSESSMENT
    ...
    public function updateCalendarInspection($dataInput = array())
    {
        ...
        $arrParam['name'] = (isset($dataInput['name'])) ? $dataInput['name'] : '';
