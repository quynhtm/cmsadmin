...
class Memcache
{
    ...
    const CACHE_PROVINCE_ALL = 'CACHE_PROVINCE_ALL';
    const CACHE_DISTRICT_ALL = 'CACHE_DISTRICT_ALL';
    const CACHE_WARDS_ALL = 'CACHE_WARDS_ALL';
    ...
    const CACHE_ALL_CATEGORY_BY_PARTNER = 'CACHE_ALL_CATEGORY_BY_PARTNER_';
    ...
    const CACHE_ALL_BANNER_BY_PARTNER = 'CACHE_ALL_BANNER_BY_PARTNER_';
