    ...
    AbstractChosen.prototype.strip_diacritics = function (string) {
      var
          translationTable = [
              ...
              "áàạãảÀÁÃẠẢâấầậẩẫÂẦẤẬẪẨăắằặẵẳĂẮẰẶẴẲéèẹẽẻÉÈẼẸẺêếềễệểÊẾỀỆỄỂđĐíìịĩỉÍÌỊĨỈóòọõỏÓÒỌÕỎôốồộỗổÔỐỒỘỖỔơớờợỡởƠỚỜỢỠỞúùụũủÚÙỤŨỦưứừựữửƯỨỪỰỮỬýỳỵỹỷÝỲỴỸỶ",
              // stripped output
              "aaaaaAAAAaaaaaaaAAAAAAaaaaaaAAAAAAeeeeeEEEEEeeeeeeEEEEEEdDiiiiiIIIIIoooooOOOOOooooooOOOOOOooooooOOOOOOuuuuuUUUUUuuuuuuUUUUUUyyyyỷYYYYỶ",
          ],
          output = '';
