...
$(document).ready(function(){
                    ...
                    if (data.success) {
                        ...
                        response($.map(data.product, function(item) {
                            return {
                                ...
                                quantity: item.product_Quantity_Fake
                            }
                        }));
                    }
                }
    ...
    $("#sys_add_product").on('click',function(){
        ...
        $.ajax({
            dataType: 'json',
            type: 'POST',
            url: WEB_ROOT + '/admin/export_fake/addProduct',
            data: {
                name: name,
                customers_id: customers_id,
                num: num
    ...
    $(".sys_delete_export").on('click',function(){
        ...
        $.ajax({
            dataType: 'json',
            type: 'POST',
            url: WEB_ROOT + '/admin/export_fake/remove',
            data: {
                export_id: export_id,
...
var Export = {
    ...
    removeItem:function(product_id){
        ...
        $.ajax({
            dataType: 'json',
            type: 'POST',
            url: WEB_ROOT + '/admin/export_fake/removeProduct',
            data: {
